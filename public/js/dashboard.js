...
function getvisitor(){
    var xhr = new XMLHttpRequest();
    var url = 'https://api.countapi.xyz/hit/api-betabot.herokuapp.com/visits';
    xhr.onloadend = function(){
    data = JSON.parse(this.responseText);
...
// Count Down Ramadhan
var countDownDate = new Date("3 April 2022, 00:00:00").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("Ramadhan").innerHTML = days + " Days " + hours + " Hours "
